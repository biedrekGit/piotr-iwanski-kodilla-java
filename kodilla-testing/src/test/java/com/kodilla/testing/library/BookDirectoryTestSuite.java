...
class BookDirectoryTestSuite {
    ...
    class listBooksInHandsOf {
        ...
        LibraryUser user = new LibraryUser("Name1", "Lastname1", "PESEL1");
        ...
        void listBooksInHandsOf0Books() {
            ...
            //when
            List<Book> theListOf2Books = bookLibrary.listBooksInHandsOf(user);

            //Then
            assertEquals(booksList, theListOf2Books);
        }

        @Test
        void listBooksInHandsOf1Books() {
            //Given
            BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
            ...
            //Then
            assertEquals(booksList, theListOf1Book);
        ...
        void listBooksInHandsOf5Books() {
            ...
            //Then
            assertEquals(booksList, theListOf5Books);
